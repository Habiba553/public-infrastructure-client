          ...
          <div className="card-body p-6 sm:p-10">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <button
                disabled={uploading}
                type="submit"
                className={`btn btn-primary w-full text-white font-bold tracking-wide transition-all shadow-md ${
                  uploading ? "loading btn-disabled" : "hover:shadow-lg hover:-translate-y-0.5"
                }`}
              >
                {uploading ? (
